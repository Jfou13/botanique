...
Le catalogue est classe par nom scientifique. Les fiches peuvent etre enrichies progressivement.
...
Cette section accueille les plantes dont la fiche est commencee mais qui doivent encore etre completees ou verifiees.

- Rien pour le moment.

## Legende des niveaux

- **Debut** : identification et besoins essentiels.
- **Intermediaire** : cycle de vie, multiplication et problemes courants.
- **Avance** : classification, ecologie, anatomie et sources croisees.
