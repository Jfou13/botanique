...
- **Nom scientifique :** *Coreopsis verticillata* 'Moonbeam'
- **Famille :** Asteraceae
- **Noms courants :** Coreopsis a feuilles verticillees, Coreopsis 'Moonbeam'
- **Origine :** Espece originaire d'Amerique du Nord ; 'Moonbeam' est un cultivar horticole
...
- **Fleurs :** petits capitules solitaires ressemblant a des marguerites, portes au sommet de tiges fines.
- **Periode de floraison :** generalement de la fin du printemps a la fin de l'ete, avec une floraison prolongee si les fleurs fanees sont retirees.
...
<td>Petales</td>
<td>Jaune pale</td>
<td><span style="display:inline-block;width:90px;height:24px;background-color:#f4d96b;border:1px solid #a88c25;">&nbsp;</span></td>
</tr>
<tr>
<td>Coeur</td>
<td>Jaune plus fonce a brun</td>
<td><span style="display:inline-block;width:90px;height:24px;background-color:#b88b35;border:1px solid #75551c;">&nbsp;</span></td>
</tr>
</table>
...
<td>Feuilles</td>
<td>Vert moyen</td>
<td><span style="display:inline-block;width:90px;height:24px;background-color:#71905b;border:1px solid #456039;">&nbsp;</span></td>
</tr>
</table>
...
3. Separer la plante en divisions comportant plusieurs pousses.
4. Replanter immediatement dans un sol draine et arroser.
...
| --- | --- | --- |
| Peu de fleurs | Manque de soleil ou sol trop riche | Installer au soleil et limiter les engrais riches. |
...
- [Royal Horticultural Society - recherche Coreopsis verticillata Moonbeam](https://www.rhs.org.uk/plants/search-results?query=Coreopsis%20verticillata%20Moonbeam), consulte le 2026-09-09.
